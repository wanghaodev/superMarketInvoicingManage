...
<link href="<%=request.getContextPath() %>/static/css/bootstrapValidator.min.css" rel="stylesheet">
   <div class="container-fluid">
        ...
        <form class="add-form" id="eshop-info-add-from" >
        	<!-- 图片相对路径 -->
        	<input type="hidden" name="oppositePath" id="oppositePath"/>
        	<!-- 图片绝对路径 -->
...
<!-- 	            	<tr> -->
<!-- 	                	<th class="form-row-th"> -->
	                	
<!-- 	                		<input type="checkbox" name="1" value="1" checked="checked"> -->
<!-- 	                		销售属性1 -->
<!-- 	                	</th> -->
<!-- 	                    <td> -->
<!-- 	                        <div class="form-group form-conttrol-th"> -->
<!-- 	                            <input type="text" class="form-control"  placeholder="属性值1" name="brandInitial" value=""> -->
<!-- 	                        </div> -->
<!-- 	                    </td> -->
<!-- 	               </tr> -->
                </tbody>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/view/merge/goods/actualGoods/js/eshop_info_add.js"></script>
...
$(function(){
	...
	$.each(saleMap.salePropertys,function(i,property){
		...
		var input = $('<input type="radio"  name="goodsMainPropertyId" value="'+property.propertyId+'" class="form-left-input"/>').appendTo($('#eshopSearchMainProperty'));
